...
- **Três fontes para colaborador, e escolher errado é bug silencioso.** `colaboradores` = quadro atual (298). `arquivo_morto` = quem tem dossiê em caixa **ou** status de saída (4.554) — inclui quem segue ativo com passagem anterior arquivada, ver ADR 0008. `employees` = tudo, e toda escrita.
