...
with open(r'C:\Users\ACPO Empreendimentos\Desktop\Nova pasta (2)\backup_gestaopessoas_2026-07-21.json', 'r', encoding='utf-8') as f:
...
with open('update_joy_life.sql', 'w', encoding='utf-8') as f:
    f.write('\n'.join(sql_lines))
