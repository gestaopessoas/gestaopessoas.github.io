...
- Name: ponto_edicao.spec.ts >> Ponto - Edição de horas >> Deve visualizar e editar o ponto de um colaborador na aba diário
- Location: e2e\ponto_edicao.spec.ts:13:7
