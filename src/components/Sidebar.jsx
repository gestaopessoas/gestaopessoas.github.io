  ...
  return (
    <aside className={`sidebar${collapsed ? ' sidebar-collapsed' : ''}`}>
      ...
      <nav className="sidebar-nav">
        ...
        {navItem('/colaboradores', Users, 'Colaboradores')}
        {navItem('/arquivo-morto', () => <Users style={{ opacity: 0.6 }} />, 'Arquivo Morto')}
        {navItem('/armarios', Lock, 'Armários')}
        {navItem('/uniformes', Shirt, 'Uniformes')}
        {navItem('/ilhas', Map, 'Ilhas & Setores')}
        {navItem('/aniversarios', Gift, 'Aniversários')}
        {navItem('/ponto', Clock, 'Controle de Ponto')}
        {navItem('/rgs', ClipboardList, 'Controle RGS')}
        {navItem('/custos', DollarSign, 'Custos Gerais')}
        {navItem('/vagas', Briefcase, 'Vagas & Recrutamento')}
